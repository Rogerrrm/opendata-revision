<template>
  <footer class="relative z-10 bg-slate-800 text-white dark:bg-dark p-6">
    <div class="container mx-auto">
      <div class="flex flex-wrap -mx-6">
        <div class="w-full px-8 sm:w-/3 lg:w-4/12">
          <div class="w-full mb-10">
            <div class="flex mb-4">
              <img src="../../../public/img/descarga.png" alt="logo" width="90" />
              <img src="../../../public/img/images.png" alt="logo" width="220" />
            </div>
            <p class="text-base text-body-color dark:text-dark-6 mb-5">
              Los datos abiertos son la clave para desbloquear la innovación.
            </p>
        ...
        <div class="w-full px-8 sm:w-1/2 lg:w-2/12">
          <div class="w-full mb-10">
    ...
    <audio id="bgAudio" loop>
      <source src="../../../public/img/coche.mp3" type="audio/mpeg">
    </audio>
  </footer>
  <slot />
</template>
