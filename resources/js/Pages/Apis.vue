...
<template>
   ...
   <aside id="separator-sidebar"
      ...
      <div class="h-full px-3 py-4 overflow-y-auto bg-header dark:bg-gray-800">
         <ul class="space-y-2 font-medium">
            <li>
               <img src="img/descarga.png" alt="logo" class="w-20 h-20 rounded-full">
               <a href="#"
            ...
            <li>
               <a href="#"
                  ...
                  <span class="flex-1 ms-3 whitespace-nowrap text-gray-50">Notificacions</span>
                  <span
         ...
         <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
            ...
            <li>
               <a href="#" id="dropdownRightEndButton" data-dropdown-toggle="dropdownRightEnd"
                  ...
                  class="flex items-center p-2 text-gray-900 transition duration-75 rounded-lg  dark:hover:bg-gray-700 dark:text-white group">
                  <svg class="flex-shrink-0 w-5 h-5 text-gray-50 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
   ...
   <div class="p-4 sm:ml-64">
    ...
    <li class="mb-10 ms-4">
        ...
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Servicios para emprender</h3>
        <p class="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Quieres empezar una gran empresa pero no sabes como? aqui tienes una gran informacion para ti.</p>
        <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">Leer mas <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
    ...
    <li class="mb-10 ms-4">
        ...
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Informacion sobre instalaciones de las empresas</h3>
        <p class="text-base font-normal text-gray-500 dark:text-gray-400">Encuntra que tipo de instalaciones tiene las empresas.</p>
        <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">Leer mas <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
  </svg></a>
    </li>
    <li class="ms-4">
        <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Inormacion sobre tipos de documentos</h3>
        <p class="text-base font-normal text-gray-500 dark:text-gray-400">Tienes dudas sobre algunos documentos y donde podrias adquirirlos aqui tienes una gran ayuda!.</p>
        <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">Leer mas <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
  </svg></a>
    </li>
    <li class="mt-4 ms-4">
        <div class="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Subvenciones para empresas</h3>
        <p class="text-base font-normal text-gray-500 dark:text-gray-400">Quieres saber las subvenciones que teneis como empresas aque esperas aqui lo tienes!.</p>
        <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:outline-none focus:ring-gray-200 focus:text-blue-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-gray-700">Leer mas <svg class="w-3 h-3 ms-2 rtl:rotate-180" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
  </svg></a>
    </li>
